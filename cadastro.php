    ...
    <div class="box">
        <header id="headerCadastro">
            <div class="row">
                ...
                <div id="divHeader" class="col-1" style="margin: auto;"><a href="contato.html" id="text"
            ...
            <div class="col-md-10">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3" id="escolherFoto">
                        <button type="button" id="trocarFotoBtn" class="btn btn-primary"
                            onclick="document.getElementById('imagem').click();">Adicionar Foto</button>
